  ...
  return (
    <main className="min-h-screen">
      <nav className="mx-auto flex max-w-7xl items-center justify-between px-4 py-6">
        ...
        <div className="hidden items-center gap-8 text-[10px] font-black uppercase tracking-[0.25em] text-muted-foreground md:flex">
      ...
      <section className="mx-auto max-w-7xl px-4 pb-16 pt-10 text-center">
        ...
        <p className="mx-auto mt-5 max-w-2xl text-sm font-semibold uppercase tracking-[0.08em] text-muted-foreground md:text-base">
          One page for supporters, one dashboard for creators, real-time alerts for stream.
        </p>
        <div className="mt-8 flex justify-center gap-3">
          <Link href="/auth/register">
            <Button className="rounded-[4px] px-7 py-3 text-[11px] font-black uppercase tracking-[0.2em]">Start Free</Button>
          </Link>
      ...
      <section id="features" className="mx-auto grid max-w-7xl gap-4 px-4 pb-16 md:grid-cols-3">
        <Card className="rounded-[6px] border-black/10">
          ...
          <p className="mt-2 text-sm text-muted-foreground">Every confirmed tip updates wallet via immutable ledger entries.</p>
        </Card>
        <Card className="rounded-[6px] border-black/10">
          <h3 className="text-lg font-black uppercase tracking-tight">OBS-ready alerts</h3>
          <p className="mt-2 text-sm text-muted-foreground">Creator-specific socket channels with low-latency alert delivery.</p>
        </Card>
        <Card className="rounded-[6px] border-black/10">
          <h3 className="text-lg font-black uppercase tracking-tight">Transparent fees</h3>
          <p className="mt-2 text-sm text-muted-foreground">Platform fee can be shown clearly so supporters know exact split.</p>
        </Card>
      </section>
      ...
      <section id="pricing" className="mx-auto max-w-7xl px-4 pb-16">
        <Card className="rounded-[6px] border-black/10">
          ...
          <p className="mt-3 max-w-2xl text-sm text-muted-foreground">No setup headache. Launch quickly and upgrade when your channel scales.</p>
        </Card>
      </section>
